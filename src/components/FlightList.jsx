                    ...
                    <>
                      ...
                      >
                        <div className="flex flex-row items-center justify-center">
                          ...
                          <p className="text-gray-200 font-semibold">{flight.details.city}</p>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                          {" "}
                          <div className="flex flex-row items-center justify-center space-x-3 mr-5">
                            <div className="flex flex-col items-center">
                              <p id="departureairport" className="text-[24px] font-bold text-indigo-700">
                            ...
                            <div className="flex flex-col items-center">
                              <p id="arrivalairport" className="text-[24px] font-bold text-indigo-700">
