...
function Footer() {
  return (
    <div className=" w-screen h-[280px] bg-[#18163e] px-4">
      <div className="w-screen h-[200px] ">
        <div className="flex flex-row space-x-20 lg:space-x-60 px-12 pt-6 ">
      ...
      <div className="flex items-center justify-center text-indigo-400 font-bold py-6">
